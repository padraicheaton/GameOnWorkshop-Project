...
namespace BreadcrumbAi{
	...
	public class Ai : MonoBehaviour {
		...
		public bool _CanFollowPlayer, _CanFollowBreadcrumbs, _CanFollowAi, _CanWander, _CanPatrol,
					...
					_CanHover,
					_CanFlee,  _CanLongJump, _IsJumping,
					_HasAvoidance, _HasEdgeAvoidance,
					_IsMelee, _IsRanged,
					_IsGround, _IsAir,
					_IsInvincible;
					
		public float followSpeed, wanderSpeed, patrolSpeed, avoidSpeed,
					 jumpDistance,  longJumpForce,
					  wanderDistance, attackDistance, avoidDistance, edgeDistance, otherAiDistance,
					 wanderTimeLimit, wanderTimeRate,
					 hoverHeight, hoverForce,
					 Health;

        [System.NonSerialized]
        public float rotationSpeed = 0.15f, jumpForce = 2.5f, followDistance = 1.0f, visionDistance = 8.0f;
        public bool _CanWanderAnywhere = false, _CanJump = true, _HasVision = true, _HasFrontVision = true;
        #endregion
